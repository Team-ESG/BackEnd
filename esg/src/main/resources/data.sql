INSERT INTO Member (FIRST_ADDR, SECOND_ADDR, THIRD_ADDR, BIRTH_DATE, DISCOUNT_PRICE, MEMBER_ID, NAME, NICK_NAME,
                    PASSWORD, PHONE_NUMBER, ROLE, SEX)
VALUES ('서울특별시', '강남구', '역삼동', '1990-01-01', 1000, 'member01', '홍길동', 'hong',
        '$2a$10$6F16tR6bSb2psdG.yM3H9OBANJgAUpmiXSQgmy73Gu7Pr/xo7TsRK', '01012345678', 'ROLE_MEMBER', 'MAN');

INSERT INTO Member (FIRST_ADDR, SECOND_ADDR, THIRD_ADDR, BIRTH_DATE, DISCOUNT_PRICE, MEMBER_ID, NAME, NICK_NAME,
                    PASSWORD, PHONE_NUMBER, ROLE, SEX)
VALUES ('부산광역시', '해운대구', '우동', '1985-05-10', 500, 'member02', '김철수', 'kim',
        '$2a$10$pw0oAflM1QmcbFywxxWJ4eZSmi.6CzOcc/pJQDPjWvQPtAGUekHvy', '01098765432', 'ROLE_MEMBER', 'MAN');
...
VALUES (2000, '2023-04-20 00:00:00.000000', '맛있는 사과', 3, '사과', 4000, 'abcd.jpg', '2023-04-18 20:01:20.000000', 0, 1);
